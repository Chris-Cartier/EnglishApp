...
class PatStoryMethod():
    ...
    def getMP3(self, mp3, index, storeAdd):
        mp3_path = r'/home/chris/Download/story/mp3/' + str(index) + r'.mp3'
    ...
    def getPicture(self, sc, index, storeAdd,pic):
        ...
        if re.findall('png', pic_url) == []:
            pic_path = r'/home/chris/Download/story/pictures/' + str(index) + r'.jpg'
            urlretrieve(pic_url, pic_path)
        else:
            pic_path = r'/home/chris/Download/story/pictures/' + str(index) + r'.png'
            urlretrieve(pic_url, pic_path)
        return pic_path
